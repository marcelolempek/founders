-- ============================================
-- CODE6MM - FIX FEED IMAGES
-- Migration 050: Corrigir URL de imagens R2 no feed
-- ============================================
-- Atualiza get_feed_posts e search_posts_by_distance
-- para retornar caminho relativo corretas para imagens R2
-- ============================================
...
-- 2. Atualizar search_posts_by_distance (usado no Explorar)
