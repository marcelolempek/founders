-- ============================================
-- CODE6MM - COMPLETE BOOST SYSTEM
-- Migration 038: Sistema completo de boost pago
-- ============================================
-- Atualiza get_feed_posts para usar is_boosted
-- Adiciona deduplicação de views
-- Remove todas as referências a is_bumped
-- ============================================

BEGIN;

-- 1. Atualizar get_feed_posts (SEM is_bumped)
...
-- 2. Tabela para tracking de views com deduplicacao
...
-- Indice unico: 1 view por usuario por post por dia
...
-- Indice para usuarios nao logados
...
-- 3. Funcao para incrementar views com deduplicacao
...
-- 4. Funcao para verificar se post esta impulsionado
...
-- ============================================
-- SISTEMA COMPLETO DE BOOST
-- ============================================
-- ✅ Feed usa is_boosted (não is_bumped)
-- ✅ Verifica expiração (boosted_until)
-- ✅ Views com deduplicação
