-- ============================================
-- CODE6MM - COMPARTILHAMENTOS
-- Migration 051: Adicionar contador de compartilhamentos
-- ============================================

BEGIN;

-- 1. Adicionar coluna shares_count na tabela posts se não existir
DO $$
BEGIN
...
-- 2. Atualizar get_feed_posts para retornar shares_count
...
RETURNS TABLE (
    ...
    shares_count INTEGER, -- Novo campo
...
BEGIN
    ...
    SELECT
        ...
        p.likes_count,
        p.comments_count,
        p.shares_count, -- Retornando novo campo
        p.status,
        p.type,
        p.is_boosted,
        p.boosted_until,
...
-- 3. Atualizar search_posts_by_distance para retornar shares_count
...
-- 4. Função para incrementar compartilhamentos
