-- ============================================
-- 070: FIX FEED EXTERNAL LINKS
-- ============================================
-- Atualiza as funcoes de feed para priorizar 
-- URLs externas (http...) mesmo que exista um image_id.
-- Isso resolve o problema de imagens "crashadas" na apresentacao.
-- ============================================

BEGIN;

-- 1. Atualizar get_feed_posts
...
BEGIN
    ...
    SELECT
        ...
        (
            SELECT 
                CASE 
                    -- PRIORIDADE 1: Se for URL externa (http), usa ela direto
                    WHEN pi.url LIKE 'http%' THEN pi.url
                    -- PRIORIDADE 2: Se tiver image_id de R2, usa o CDN
...
-- 2. Atualizar search_posts_by_distance
