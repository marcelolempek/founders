-- ============================================
-- CODE6MM - NATIONAL FEED ALGORITHM V2
-- Migration 035: Algoritmo completo de feed nacional
-- ============================================
-- Implementa sistema de pontuação completo:
-- - BOOST_IMPULSIONADO: 1000 pts
-- - SCORE_LOCALIZACAO: 0-200 pts (cidade, estado, envio nacional, região)
-- - SCORE_CONFIANCA: 0-150 pts (verificado, rating, vendas)
-- - SCORE_ENGAJAMENTO: 0-100 pts (likes, views, comments, saves)
-- - SCORE_FRESHNESS: 0-50 pts (recência do post)
-- ============================================

BEGIN;

-- Atualizar função get_feed_posts com algoritmo completo
...
BEGIN
    ...
    SELECT
        ...
        (
            -- BOOST IMPULSIONADO (1000 pontos)
...
-- ============================================
-- BENEFICIOS DO NOVO ALGORITMO
-- ============================================
-- ✅ Posts com envio nacional aparecem para todo o Brasil
-- ✅ Vendedores com boa reputação ganham destaque
-- ✅ Posts populares (muitos likes/views) sobem no ranking
-- ✅ Posts recentes têm vantagem
-- ✅ Proximidade geográfica ainda é priorizada
-- ✅ Impulsionados sempre no topo
-- ============================================
