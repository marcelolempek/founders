-- ============================================
-- FIX: Ambiguous column reference in get_feed_posts
-- ============================================
-- This fixes the "column reference location_city is ambiguous" error
-- by explicitly qualifying all column references with table aliases
-- ============================================
